...
void main() async {
  ...
  final allEventsSubscription = eventBus.onAny((event) {
    print(
      '📥 Any event received: ${event.name} with data: ${jsonEncode(event.data)}',
    );
  });
  ...
  bridgeController.sendToJavaScript(
    'updateUI',
    data: {'visible': true, 'color': 'blue'},
  );
  ...
  Timer(Duration(milliseconds: 500), () {
    ...
    mockController.simulateMessageFromJavaScript(
