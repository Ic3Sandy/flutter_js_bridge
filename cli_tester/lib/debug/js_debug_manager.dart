...
import 'package:flutter_js_bridge_cli_tester/debug/js_bridge_logger.dart';
import 'package:flutter_js_bridge_cli_tester/debug/js_debug_config.dart';
import 'package:flutter_js_bridge_cli_tester/debug/js_message_inspector.dart';
import 'package:flutter_js_bridge_cli_tester/debug/js_performance_monitor.dart';
...
class JSDebugManager {
  ...
  T trackSyncOperation<T>(
    ...
    if (_config.isPerformanceMonitoringEnabled) {
      return _performanceMonitor.trackSyncOperation(operationName, operation);
    } else {
      return operation();
    }
  }
